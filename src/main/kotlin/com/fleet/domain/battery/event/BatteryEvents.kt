...
data class BatteryPackCreatedEvent(
    ...
    override fun getEventData() = mapOf(
        ...
        "nominalVoltage" to specifications.nominalVoltage.volts,
...
data class TelemetryRecordedEvent(
    ...
    override fun getEventData() = mapOf(
        ...
        "cellVoltages" to reading.cellVoltages.voltages,
...
/**
 * Charging Interrupted Event
 * Raised when charging stops before reaching full charge
 * (e.g., user unplugged, power failure, emergency stop)
 */
data class ChargingInterruptedEvent(
    val batteryPackId: BatteryPackId,
    val stateOfCharge: StateOfCharge,
    val chargingSessionId: UUID,
    val durationMinutes: Long,
