...
class TimescaleEventStoreImpl(
    ...
    private fun deserializeBatteryPackCreatedEvent(
        ...
        // Simplified - in production, you'd reconstruct value objects properly
        return BatteryPackCreatedEvent(
            ...
            specifications = com.fleet.domain.battery.model.BatterySpecifications(
                ...
                chemistry = com.fleet.domain.battery.model.BatteryChemistry.valueOf(data["chemistry"] as String),
                nominalVoltage = com.fleet.domain.battery.model.Voltage.of((data["nominalVoltage"] as Number).toDouble()),
