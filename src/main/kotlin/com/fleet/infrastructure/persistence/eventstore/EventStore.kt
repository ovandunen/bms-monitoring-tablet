...
interface EventStore {
    ...
    /**
     * Get all distinct aggregate IDs for a given type
     * More efficient than getAllEvents when only IDs are needed
     * 
     * @param aggregateType Type of aggregate
     * @return List of aggregate IDs
     */
    suspend fun getAggregateIds(aggregateType: String): List<String>
}
